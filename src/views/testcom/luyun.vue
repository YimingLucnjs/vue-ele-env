<template>
  <div class="chart-container">
    ...
    <div style="height:250px;width:380px;margin-left: 0px;">
      <PieFullChart
        height="100%"
        width="100%"
      />
    ...
    <div style="height:60px;width:66px;">
      <NumberIndex />
    </div>
  </div>
</template>
...
export default {
  name: 'KeyboardChart',
  components: { PieChart, BrokenLineChart, PieFullChart, LunBo, LinePercentage, TopRank, NumberIndex }
}
</script>
